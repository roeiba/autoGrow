...
class IssueGenerator:
    ...
    def check_and_generate(self) -> bool:
        ...
        open_issues = list(retry_github_call(self.repo.get_issues, state="open"))
    ...
    def _generate_issues(self, needed: int, open_issues: List) -> None:
        ...
        try:
            ...
            readme = readme_obj.decoded_content.decode("utf-8")[:1000]
        except:
            readme = "No README found"

        recent_commits = list(retry_github_call(self.repo.get_commits)[:5])
        commit_messages = "\n".join(
